...
#### RAM increase: define if this actrrion needs to increase users RAM and if so by how much. See [Resource Management](https://developers.Trussprotocol.io/Truss-protocol/resource-management) for more details.
#### Request
